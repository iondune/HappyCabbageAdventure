...
void CLWIBState::PrepSky() {
  ...
  /* CMeshSceneObject *tempBlock;
   ...
   tempBlock->setTranslation(SVector3f(85, 13, -5));
...
void CLWIBState::pickInsert()
{
    if (change == 0) {
        ...
        //PreviewBlock->setScale(SVector3f((float) blockWidth, (float) blockHeight, (float) blockDepth));
    }
    if (change == 1) {
        oneDown = 1;
        threeDown = 0; 
